...
<h2>Complément Fiche</h2>
			...
			<h5 class="offset1">L'ajout du manga complètera la fiche...</h5>
			<form class="span7 offset2 form-horizontal" name="manga" method="POST" enctype="multipart/form-data" action="index.php?module=Administration&action=addManga">
				<div id="manga">
