...
class Model_Game extends Model_Template {
    ...
    protected $selectGameByNickname;
    ...
    public function __construct() {
        ...
        $sql = 'SELECT * FROM game WHERE nickname = ?';
        $this->selectGameByNickname = Controller_Template::$db->prepare($sql);
    ...
    public function getGameByNickname($nickname){
        $this->selectGameByNickname->excute(array($nickname));
        return $this->selectGameByNickname->fetchAll();
    }
